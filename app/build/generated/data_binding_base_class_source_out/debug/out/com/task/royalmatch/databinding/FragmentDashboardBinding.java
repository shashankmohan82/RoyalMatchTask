...
public final class FragmentDashboardBinding implements ViewBinding {
  ...
  private FragmentDashboardBinding(@NonNull ConstraintLayout rootView,
      @NonNull AppCompatImageView imageHeader, @NonNull TextView textDashboard) {
  ...
  public static FragmentDashboardBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.image_header;
      AppCompatImageView imageHeader = ViewBindings.findChildViewById(rootView, id);
      if (imageHeader == null) {
        break missingId;
      }
      ...
      return new FragmentDashboardBinding((ConstraintLayout) rootView, imageHeader, textDashboard);
    }
